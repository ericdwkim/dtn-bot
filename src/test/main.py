...
def user_journey():
    ...
    try:
        ...
        if not group_filter_set_to_draft_notice:
            return
        draft_notices_processed_and_filed = process_pdfs(full_path_to_downloaded_pdf, company_name_to_subdir_full_path_mapping_fuel_drafts, company_names, regex_patterns, doc_type_abbrv_to_doc_type_dir_map, company_id_to_company_subdir_map, post_processing=False)
        ...
        # CCM, LRD files
        ccm_files_processed = process_pdfs(full_path_to_downloaded_pdf, company_name_to_subdir_full_path_mapping_credit_cards, company_names, regex_patterns, doc_type_abbrv_to_doc_type_dir_map, company_id_to_company_subdir_map, post_processing=True)
