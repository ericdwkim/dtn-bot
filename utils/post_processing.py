...
def save_merged_pdf(file_prefix, merged_pdf, total_amount_sum, company_id, doc_type_abbrv_to_doc_type_map, company_id_to_compaany_subdir_map):
    ...
    month_directory = calculate_directory_path(file_prefix, company_id, new_file_name, doc_type_abbrv_to_doc_type_map, company_id_to_compaany_subdir_map)
